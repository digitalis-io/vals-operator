...
require (
	...
	github.com/openbao/openbao/api/auth/approle/v2 v2.5.0
	github.com/openbao/openbao/api/auth/kubernetes/v2 v2.5.0
	github.com/openbao/openbao/api/auth/userpass/v2 v2.5.0
